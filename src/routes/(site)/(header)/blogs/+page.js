...
export const load = async () => {
	const all_blogs_meta =
		/** @type { {date: String, title: string, created: string, tags: string[] | undefined, excerpt: string, id: string, pimage: () => Promise<object>}[]} */
		(
			Object.entries(
			...
			.map((v) => ({ ...v, pimage: blog.fetch_thumbnail(v.id) }));
